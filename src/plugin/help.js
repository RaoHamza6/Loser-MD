...
╰─────────────━┈⊷ `
            ...
            header: proto.Message.InteractiveMessage.Header.create({
                ...(await prepareWAMessageMedia({ image : fs.readFileSync('./src/loser.jpg')}, { upload: Matrix.waUploadToServer})), 
                  title: ``,
                  gifPlayback: true,
                  subtitle: "",
          ...
          "buttonParamsJson": JSON.stringify({
            ...
            id: `${prefix}ping`
        ...
        },
                {
                 ...
                 "sections":
                   [{
                    "title":"😎 ＬＯＳＥＲ-ＭＤ ＡＬＬＭＥＮＵ",
                    "highlight_label":"🤩 𝛥𝐿𝐿𝛭𝛯𝛮𝑈",
                    "rows":[
                      {
                       "header":"",
                       "title":"🔰 ᴀʟʟ ᴍᴇɴᴜ",
                       "description":"🎨ＬＯＳＥＲ-ＭＤ ＡＬＬＭＥＮＵ🎨",
                       "id":"View All Menu"
                      },
                      {
                        "header":"",
...
╰━━━━━━━━━━━━━━━⪼
  ...
  image: fs.readFileSync('./src/loser.jpg'), 
  caption: str, 
  contextInfo: { 
                  mentionedJid: [m.sender], 
                  forwardingScore: 999,
